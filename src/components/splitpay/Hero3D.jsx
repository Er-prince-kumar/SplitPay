    ...
    <section className="relative flex-1 flex items-center py-4 sm:py-6 px-3 sm:px-5 md:px-6 lg:px-8 overflow-hidden w-full">
      <div className="w-full max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-center">
        ...
        <div className="lg:col-span-6 w-full max-w-lg mx-auto lg:max-w-none">
          <div className="rounded-2xl p-4 sm:p-5 bg-[#121324] border border-white/10 shadow-xl space-y-3.5">
            ...
            <div className="flex items-center justify-between pb-2.5 border-b border-white/10">
              ...
              <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-[#C6FF3D]/10 text-[#C6FF3D] border border-[#C6FF3D]/20">
                Live Preview
              </span>
            </div>
            ...
            {/* Numbers Display */}
            <div className="p-3 rounded-xl bg-[#0B0C16] border border-white/10 grid grid-cols-2 gap-2">
              <div>
                <span className="text-[10px] font-mono text-white/40 block">TOTAL BILL</span>
                <span className="text-xl sm:text-2xl font-black text-white font-['Space_Grotesk']">
                  ₹{currentPreset.amount.toLocaleString('en-IN')}
                </span>
              </div>
              <div className="text-right">
                <span className="text-[10px] font-mono text-[#C6FF3D] block">EACH PERSON</span>
                <span className="text-xl sm:text-2xl font-black text-[#C6FF3D] font-['Space_Grotesk']">
              ...
              {squad.map((member) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    {member.status === 'paid' ? (
                      <span
                        className="px-2 py-0.5 rounded-lg text-xs font-mono font-bold flex items-center gap-1 bg-[#C6FF3D]/15 text-[#C6FF3D] border border-[#C6FF3D]/30 select-none cursor-default shadow-sm"
                      ...
                      <span
                        className="px-2 py-0.5 rounded-lg text-xs font-mono font-bold flex items-center gap-1 bg-amber-400/15 text-amber-400 border border-amber-400/30 select-none cursor-default"
            ...
            <button
              ...
              className="w-full py-2 rounded-xl bg-white/5 hover:bg-white/10 text-white/80 hover:text-white border border-white/10 text-xs font-medium transition-colors cursor-pointer flex items-center justify-center gap-1.5"
            >
              <span>Sign in to create your own split</span>
