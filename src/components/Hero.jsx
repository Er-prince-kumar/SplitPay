...
const Hero = ({ onOpenResume }) => {
  ...
  const developerRoles = [
    'FEATURE FILM // COMPUTER SCIENCE ENGINEER',
    'ORIGINAL SERIES // AI & FULL-STACK DEVELOPER',
    'BLOCKBUSTER // C++ & PYTHON SPECIALIST',
    'ACCLAIMED // IOT & NLP ARCHITECT'
  ];
  ...
  useEffect(() => {
    ...
    // --- 3D CARD PERSPECTIVE & GLARE PHYSICS ---
    ...
    >
      ...
      <div ref={contentRef} className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 h-full flex flex-col justify-between pt-24 pb-12">
        ...
        <div className="hero-anim-item flex items-center justify-between w-full">
          <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded bg-black/80 backdrop-blur-2xl border border-red-600/40 text-xs font-mono uppercase tracking-widest text-white shadow-2xl">
            ...
            <span className="text-white/80">SEASONS 2025 - 2026</span>
          </div>
          <div className="hidden md:flex items-center gap-2 text-xs font-mono text-white/50 tracking-wider">
            <span className="px-2 py-0.5 border border-red-600/40 rounded bg-red-600/10 text-red-400 font-bold">LPU CGPA: 7.33</span>
            <span className="px-2 py-0.5 border border-white/20 rounded bg-black/40">ORACLE AI CERTIFIED</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-8 my-auto">
          ...
          <div className="lg:col-span-5 flex flex-col items-start space-y-5 text-left">
            ...
            <div className="hero-anim-item flex items-center gap-3">
              ...
              <span className="text-white/80 text-xs font-mono tracking-widest uppercase">Computer Science Engineer & Problem Solver</span>
            </div>
            ...
            <div className="hero-anim-item flex flex-wrap items-center gap-2 text-xs font-mono text-red-400 font-bold">
              <span className="px-2 py-0.5 bg-red-500/10 border border-red-500/30 rounded text-red-500">CGPA: 7.33</span>
              <span className="text-white/40">•</span>
              <span>C++ • Python • JavaScript</span>
              <span className="text-white/40">•</span>
              <span className="text-white/70">MySQL • NLP • IoT</span>
            </div>

            <p className="hero-anim-item text-sm md:text-base text-white/80 font-light leading-relaxed max-w-md drop-shadow">
              B.Tech CSE engineer at Lovely Professional University. Architecting AI healthcare platforms, hybrid RFID biometric systems, and scalable full-stack web applications.
            </p>
            ...
            <div className="hero-anim-item flex flex-wrap items-center gap-3 pt-2">
              ...
              <button
                ...
                className="px-7 py-3 bg-red-600 hover:bg-red-700 text-white font-bold text-xs uppercase tracking-widest rounded transition-all duration-300 shadow-[0_0_25px_rgba(229,9,20,0.6)] flex items-center gap-2 hover:scale-105 active:scale-95"
              >
          ...
          <div className="hero-anim-item lg:col-span-3 flex flex-col items-start lg:items-end space-y-4 text-left lg:text-right">
            <div className="p-5 bg-black/80 backdrop-blur-2xl border border-white/15 rounded-xl shadow-2xl max-w-xs">
              <h3 className="text-xs font-mono uppercase tracking-widest text-red-500 font-bold mb-2">Key Accolades &amp; Stats</h3>
              <p className="text-xs text-white/80 leading-relaxed font-light">
                Oracle Cloud Infrastructure 2025 AI Foundations Associate &bull; Infosys AI Certified &bull; 10+ LeetCode Solved &bull; WNS Cares Foundation Digital Trainer.
              </p>
            </div>
          </div>
        ...
        <div className="hero-anim-item flex items-center justify-between text-xs font-mono text-white/50 tracking-widest uppercase">
          <span>LOVELY PROFESSIONAL UNIVERSITY &bull; B.TECH CSE</span>
      ...
      <header className="absolute top-0 left-0 z-50 w-full max-w-7xl mx-auto px-6 md:px-12 py-6 flex items-center justify-between pointer-events-auto">
        <div className="text-2xl font-black text-red-600 tracking-tighter flex items-center gap-2 drop-shadow-[0_2px_15px_rgba(229,9,20,0.9)]">
          PRINCE KUMAR<span className="w-1.5 h-1.5 rounded-full bg-white inline-block"></span>
        </div>
        ...
        <div className="flex items-center gap-3">
          <button
            type="button"
            onClick={onOpenResume}
            className="hidden sm:inline-flex px-4 py-2 rounded bg-white/10 hover:bg-white/20 text-white font-bold text-xs uppercase tracking-widest transition-all"
          >
            CV
          </button>
          <a
