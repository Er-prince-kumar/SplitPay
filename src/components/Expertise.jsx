...
const expertiseData = [
  {
    ...
    text: "Mastering C++, Python, Java, and C with deep focus on Object-Oriented Programming (OOPs), data structures, algorithmic problem solving, and computational efficiency.",
    tag: "LANGUAGES & ALGORITHMS",
    gradient: "from-[#1f0a0c] via-[#121212] to-[#0a0a0a]"
  },
  {
    number: "02",
    title: "Full-Stack Web Development",
    text: "Building responsive, modern web interfaces and dashboards using JavaScript, HTML5, CSS3, React, and interactive data visualizations with Chart.js.",
    tag: "WEB & VISUALIZATION",
    gradient: "from-[#1a0809] via-[#111111] to-[#090909]"
  },
  {
    number: "03",
    title: "AI, NLP & IoT Biometrics",
    text: "Engineering AI healthcare platforms with NLP symptom triage and severity analysis, alongside hybrid Arduino & RFID biometric attendance hardware solutions.",
    tag: "AI & IOT HARDWARE",
    gradient: "from-[#220a0d] via-[#131313] to-[#0a0a0a]"
  },
  {
    number: "04",
    title: "Databases & Core CS Fundamentals",
    text: "Architecting structured relational databases with MySQL, optimizing SQL queries, implementing normalized schemas, and adhering to rigorous DBMS best practices.",
    tag: "MYSQL & DBMS",
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full space-y-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2">
          ...
          <p className="text-white/60 text-xs md:text-sm font-light leading-relaxed max-w-xs">
            Merging core programming languages, artificial intelligence, IoT hardware, and relational database systems into functional productions.
          </p>
        </div>
