        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 md:mb-12 gap-4">
            ...
            <span className="text-xs font-mono text-white/40 tracking-wider">
              PRINCE KUMAR &bull; OPEN TO FULL-TIME &amp; INTERNSHIP ROLES
            </span>
          </div>

          {/* Direct Communication Channels */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10 pb-10 border-b border-white/10">
            <a 
              href="mailto:princebxr2000@gmail.com"
              className="p-4 rounded-xl bg-white/[0.04] border border-white/10 hover:border-red-600/50 hover:bg-red-600/10 transition-all flex flex-col gap-1 group"
            >
              <span className="text-[10px] font-mono uppercase text-red-500 font-bold">Email Direct</span>
              <span className="text-xs font-semibold text-white group-hover:text-red-400 transition-colors truncate">princebxr2000@gmail.com</span>
            </a>

            <a 
              href="tel:+917717723919"
              className="p-4 rounded-xl bg-white/[0.04] border border-white/10 hover:border-red-600/50 hover:bg-red-600/10 transition-all flex flex-col gap-1 group"
            >
              <span className="text-[10px] font-mono uppercase text-red-500 font-bold">Mobile Phone</span>
              <span className="text-xs font-semibold text-white group-hover:text-red-400 transition-colors">+91-7717723919</span>
            </a>
            ...
            <a 
              ...
              className="p-4 rounded-xl bg-white/[0.04] border border-white/10 hover:border-red-600/50 hover:bg-red-600/10 transition-all flex flex-col gap-1 group"
            >
              <span className="text-[10px] font-mono uppercase text-red-500 font-bold">LinkedIn Network</span>
              <span className="text-xs font-semibold text-white group-hover:text-red-400 transition-colors">in/cse-prince-kumar &rarr;</span>
            </a>

            <a 
              href="https://github.com/Er-prince-kumar"
              target="_blank"
              rel="noopener noreferrer"
              className="p-4 rounded-xl bg-white/[0.04] border border-white/10 hover:border-red-600/50 hover:bg-red-600/10 transition-all flex flex-col gap-1 group"
            >
              <span className="text-[10px] font-mono uppercase text-red-500 font-bold">GitHub Codebase</span>
              <span className="text-xs font-semibold text-white group-hover:text-red-400 transition-colors">@Er-prince-kumar &rarr;</span>
            </a>
          </div>
