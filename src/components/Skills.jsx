...
const skillCategories = [
  { 
    ...
    desc: 'Writing clean, high-performance, and object-oriented code across core system and development languages.', 
    tag: 'LANGUAGES',
    skills: ['C++', 'Python', 'C', 'Java', 'JavaScript'] 
  },
  { 
    title: 'Web & Frontend Development', 
    desc: 'Designing responsive web dashboards, structured layouts, interactive interfaces, and dynamic Chart.js visualizations.', 
    tag: 'WEB & UI',
    skills: ['HTML5', 'CSS3', 'JavaScript', 'Chart.js', 'Responsive Design'] 
  },
  { 
    title: 'Databases & CS Fundamentals', 
    desc: 'Engineering relational databases, normalized schemas, complex SQL queries, and robust Object-Oriented principles.', 
    tag: 'DBMS & CORE CS',
    skills: ['MySQL', 'SQL', 'DBMS', 'OOPs', 'Data Structures'] 
  },
  { 
    title: 'AI, NLP & IoT Biometrics', 
    desc: 'Building intelligent NLP symptom triage platforms and integrating embedded Arduino microcontrollers with RFID & biometric sensors.', 
    tag: 'AI & HARDWARE',
    skills: ['NLP Triage', 'AI Foundations', 'Arduino', 'RFID', 'Face Recognition'] 
  },
  { 
    title: 'Tools & Ecosystem', 
    desc: 'Equipped with industry-standard version control, API testing suites, and collaborative development platforms.', 
    tag: 'DEV TOOLS',
    skills: ['Git', 'GitHub', 'VS Code', 'Postman', 'GeeksforGeeks'] 
  },
  { 
    title: 'Problem Solving & Leadership', 
    desc: 'Demonstrated algorithmic problem solving on LeetCode, effective team coordination, rapid adaptability, and digital security mentorship.', 
    tag: 'LEADERSHIP & PROBLEM SOLVING',
    skills: ['Problem-Solving', 'LeetCode', 'Team Player', 'Project Management', 'Adaptability'] 
  },
];
